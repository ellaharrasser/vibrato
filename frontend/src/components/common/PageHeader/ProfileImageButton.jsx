  ...
  return (
    <div className="w-[36px] h-full">
      <img
        className={
          selectedStyle +
          "w-auto h-full rounded-full border-solid border-2 cursor-pointer transition-all hover:border-stone-600"
        }
      ...
      <div className="w-0 h-fit flex flex-col flex-nowrap">
        <ul
          ...
          className={
            hiddenStyle +
            "transition-all w-max mx-[5px] p-1 relative top-0 right-[60px] list-none border-l-[4px] border-solid border-stone-600 rounded-[2px] bg-white"
          }
          ref={ulRef}
        >
          {user && (
            <>
              ...
              <li
                onClick={logout}
                className=" transition-colors hover:text-teal-500 cursor-pointer"
              >
                Log Out
              </li>
            </>
