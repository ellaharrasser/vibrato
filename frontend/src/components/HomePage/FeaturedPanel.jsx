...
function FeaturedPanel() {
    return (
        <div className='container w-fit mx-auto p-6 text-center rounded-lg bg-[linear-gradient(10deg,_#fed7aa,_#fcd34d)]'>
            ...
            <NavLink to='/products' className='inline-block w-auto px-4 py-2 rounded-full text-xl lg:text-2xl font-semibold text-amber-50 bg-stone-800 transition-colors hover:bg-stone-700'>
                Explore Products
            </NavLink>
        </div>
    )
